...
| wissen willst, was der Hub über die Storen weiss | `docker exec homepilot-hub python -m homepilot.storencheck` – oben, was der Hub meint (Zustand, Stellung, ob nur angenommen, wie alt), darunter, was das Gateway roh meldet und was sich ändert, wenn man es nachlesen lässt |
