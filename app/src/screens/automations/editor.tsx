...
import { Compare, ConditionKind, Draft, DryRun, EMPTY_STEP, StepDraft, StepKind, TriggerDraft, TriggerKind, WEEKDAY_LABELS, buildConditions, conditionOptions, delayLabel, fittingState, fittingTrigger, KAMERA_AUSLOESER, PLATZHALTER, hatWartezeit, measurableAttributes, melderMitLux, newTrigger, optionKey, stateOptions, stepsToActions, triggerToConfig, weekdayLabel } from './entwurf';
import {
  CategoryField,
  Choice,
  EntityPicker,
