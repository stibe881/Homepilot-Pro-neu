...
const makeStyles = (colors: Colors) =>
  StyleSheet.create({
    ...
    editor: { flex: 1, backgroundColor: colors.surfaceStrong },
    ...
    choiceTextActive: { color: colors.surfaceStrong },
    save: {
    ...
    saveText: { color: colors.surfaceStrong, fontWeight: '700', fontSize: 16 },
